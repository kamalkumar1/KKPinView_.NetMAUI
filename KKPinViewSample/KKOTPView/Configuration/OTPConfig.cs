...
public sealed class OTPConfigBuilder
{
    ...
    public OTPConfigBuilder FieldShape(KKPinFieldShapeType shape, double cornerRadius = 10)
    {
    ...
    public OTPConfigBuilder ResendButtonFont(double fontSize = 16, FontAttributes attributes = FontAttributes.None, string? fontFamily = null)
    {
    ...
    public OTPConfigBuilder ResendCountdownFont(double fontSize = 16, FontAttributes attributes = FontAttributes.None, string? fontFamily = null)
    {
    ...
    /// <summary>Sets custom validator for app-wide use. Return true if OTP is valid.</summary>
    public OTPConfigBuilder OnValidate(Func<string, bool> validator)
    {
    ...
    public OTPConfigBuilder ResendCooldown(int seconds)
    {
        _config.ResendCooldownSeconds = seconds;
        return this;
    }

    /// <summary>Enables paste support (default true).</summary>
    public OTPConfigBuilder EnablePaste(bool enable = true)
    {
        _config.EnablePasteSupport = enable;
        return this;
    }

    /// <summary>Enables iOS SMS one-time-code autocomplete.</summary>
    public OTPConfigBuilder EnableAutoReadSMS(bool enable = true)
    {
